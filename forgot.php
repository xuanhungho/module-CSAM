...
<body>
<br>
<form method="post" action="sendmailforgot.php">
<div class="container">
	<div class="alert alert-success" role="alert">
    <h4 class="alert-heading">Trung tâm quản lý Ký túc xá Đại học Bách khoa Hà Nội!</h4>
    <hr>
...
<br>
    ...
    <div class="form-row">
        <div class="form-group col-sm-12">
            <h5>Nhập email của bạn, chúng tôi sẽ gửi 1 mã kích hoạt về hòm thư giúp bạn tạo một mật khẩu mới</h5>
    ...
    <div class="form-row">
        ...
        <div class="form-group col-sm-4 ">
            <input type="submit" name="add" value="Nhận mã kích hoạt" class="btn btn-danger"/>
        </div>        
	</div>
</div>
</form>
